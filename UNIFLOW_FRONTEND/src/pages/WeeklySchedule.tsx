...
const WeeklySchedule: React.FC = () => {
  ...
  const getCourseColor = (courseCode: string) => {
    ...
    return colors[courseCode as keyof typeof colors] || '#E0E0E0';
  };
        ...
        <PageHeader
          ...
          rightContent={
            <div className="header-actions">
              <button className={`view-toggle ${selectedView === 'day' ? 'active' : ''}`} onClick={() => setSelectedView(selectedView === 'week' ? 'day' : 'week')}>
                ...
                {days.map((day) => {
                  ...
                  return (
                    <div 
                      ...
                      className={`schedule-cell ${isEditMode ? 'editable' : ''} ${isCurrentTime ? 'current-time' : ''}`}
